...
public class TravelListTextCoordinates {
    public static final List<TextCords> fullNameCoordinates = List.of(
            new TextCords(1100, 445),
            new TextCords(900, 3010)
    );
    public static final List<TextCords> personalNumberCoordinates = List.of(
    ...
    public static final List<TextCords> monthAndYearCoordinates = List.of(
    ...
    public static final List<TextCords> destinationAndReasonCoordinates = List.of(
    ...
    public static final List<TextCords> kilometersForEachDayCoordinates = List.of(
    ...
    public static final List<TextCords> destinationAndReasonWithNightStayCoordinates = List.of(
            new TextCords(792, 933 ),   //day1
            new TextCords(792, 998 )   //day2
    );
    public static final List<TextCords> kilometersForEachDayWithNightStayCoordinates = List.of(
            new TextCords(1990, 933 ),   //day1
            new TextCords(1990, 998 )  //day2
    );
}
